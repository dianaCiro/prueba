...
public class CalculoDeDiasDeVacacionesTest {
	...
	public void anioDEsolicitudTest() {
		...
		testSolicitudVacaciones = new SolicitudVacaciones(fechaInicioVacionesTest, fechaFinVacionesTest, "David",EstadosSolicitud.PENDIENTE.getValue(),"sebastian.eusse");
